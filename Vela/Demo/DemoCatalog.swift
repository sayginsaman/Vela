...
enum DemoCatalog {
    static let tracks: [DemoTrack] = [
        ...
        DemoTrack(id: "demo-velvet-hour", title: "Velvet Hour", artist: "Odile Marchetti", album: "After Hours",
                  duration: 96, bpm: 118, lyricsResource: ("velvet-hour", "lrc"), isInstrumental: false,
                  hues: [0.08, 0.05, 0.13], artworkSeed: 83, genre: "Jazz", fixtureProfile: .jazzBlues),
        DemoTrack(id: "demo-fuego-lento", title: "Fuego Lento", artist: "Mara Solís", album: "Calor",
                  duration: 96, bpm: 96, lyricsResource: ("fuego-lento", "lrc"), isInstrumental: false,
                  hues: [0.02, 0.12, 0.45], artworkSeed: 89, genre: "Latin", fixtureProfile: .latinAfrobeats),
        DemoTrack(id: "demo-glass-orchards", title: "Glass Orchards", artist: "Fern & Static", album: "Small Weather",
                  duration: 92, bpm: 124, lyricsResource: ("glass-orchards", "lrc"), isInstrumental: false,
                  hues: [0.55, 0.12, 0.38], artworkSeed: 97, genre: "Indie", fixtureProfile: .indieAlternative),
